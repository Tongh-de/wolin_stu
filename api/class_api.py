...
@router.get("/", response_model=response.ResponseBase)
...
# 获取单个班级
@router.get("/{class_id}", response_model=response.ResponseBase)
def read_one_class(
        class_id: int,
        db: Session = Depends(get_db),
...
# 创建班级
@router.post("/", response_model=response.ResponseBase, status_code=201)
...
# 更新班级
@router.put("/{class_id}", response_model=response.ResponseBase)
...
# 删除班级
@router.delete("/{class_id}", response_model=response.ResponseBase)
...
# 恢复班级
@router.post("/{class_id}/restore", response_model=response.ResponseBase)
